...
public:
	...
	//Exercise 4.2
	//the returned value of can not be changed
    ...
    void move(Direction dir); //move the cursor in the direction of choice
	...
	//Exercise 4.2
	//The value of string s passed by reference, so const prevent any modifications of string s
...
//Exercise 4.2
//const ensures that the screens size cannot be changed
	void display() const;
